...
My two main personal projects are [Coltra](https://github.com/RedTachyon/coltra-rl), which was a "classic" RL library I mostly used for my PhD and random other experiments; and [gyllm](https://github.com/RedTachyon/gyllm), which is a gym(nasium)-inspired API for LLM RL envs, with some simple single-GPU algorithms included.
